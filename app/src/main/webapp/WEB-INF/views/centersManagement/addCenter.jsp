...
<spring:url var = "addCenter" value="/centersManagement/addCenter" />
<div id="global">
    <form:form modelAttribute="newCenter"  action= "${addCenter }" method="post">
        <fieldset>
            <legend>Add a center</legend>
            <p>
...
<%--            </p>--%>
            <p>
                <label for="id"><spring:message code="center.id" /> </label>
            ...
            <p>
                <label for="name"><spring:message code="center.name" /> </label>
            ...
            <p>
                <label for="status"><spring:message code="center.status" /> </label>
...
<%--            </p>--%>
            ...
            <p id="buttons">
                <input id="submits" type="submit" value="Add Center">
            </p>
        </fieldset>
    </form:form>
</div>
