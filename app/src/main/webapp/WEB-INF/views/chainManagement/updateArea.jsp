...
<spring:url var = "updateChain" value="/chainManagement/updateChain" />

<div id="global">
    <form:form commandName="chain" action= "${updateChain}" >
        <fieldset>
            <legend>Update the Chain</legend>
            <form:hidden path="id"/>
<%--            <p>--%>
...
<%--            </p>--%>
            ...
            <p id="buttons">
                <input id="submit" type="submit"  value="Update Chain">
            </p>
        </fieldset>
    </form:form>
</div>
