...
<spring:url var ="addArea" value="/areaManagement/addArea" />
<div id="global">
    <form:form modelAttribute="newArea" action= "${addArea }" method="post">
        <fieldset>
            <legend>Add an Area</legend>
            <p>
...
<%--            </p>--%>
            <p>
                <label for="id"><spring:message code="area.id" /> </label>
            ...
            <p>
                <label for="name"><spring:message code="area.name" /> </label>
            ...
            <p>
                <label for="status"><spring:message code="area.status" /> </label>
...
<%--            </p>--%>
            ...
            <p id="buttons">
                <input id="submits" type="submit" value="Add Area">
            </p>
        </fieldset>
    </form:form>
</div>
